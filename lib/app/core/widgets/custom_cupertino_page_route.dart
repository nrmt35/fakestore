...
import 'custom_cupertino_page_transition_theme.dart';
...
class _CupertinoBackGestureDetectorState<T> extends State<_CupertinoBackGestureDetector<T>> {
  ...
  double get _backGestureWidth {
    final theme = BackGestureWidthTheme.maybeOf(context);
    if (theme != null) {
      return theme.backGestureWidth(() => MediaQuery.sizeOf(context));
    }
...
Widget _buildCupertinoDialogTransitions(BuildContext context, Animation<double> animation,
    Animation<double> secondaryAnimation, Widget child) {
